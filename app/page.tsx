...
export default function Home() {
  return (
    <>
      ...
      <p>
       Most of all, I love collaborating and ideating with curious and transformative people. Some awesome VCs have financially enabled me to explore these ideas. Feel free to reach out.
      </p>
